...
If you'd like to develop and/or build the CEBRA-Lens jupyter-book book, you should:
...
We welcome and recognize all contributions. You can see a list of current contributors in the [contributors tab](https://github.com/eloisehabek/cebra_lens_jupyter_book/graphs/contributors).
