...
@pytest.mark.parametrize(
    "embeddings,labels,n_jobs,match", _initialize_invalid_embedding_ensembling_data()
)  # allows you to have multiple values for parameters. e.g. if 3 values, test will be done 3 times
