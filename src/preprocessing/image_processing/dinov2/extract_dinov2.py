...
if __name__ == "__main__":
    ...
    image_folder_paths = extract_stimuli_paths(stimuli)
    print("stimuli: ", stimuli)
    print("image paths: ", image_folder_paths)
    ...
    for stimulus in stimuli:
        ...
        image_folder = image_folder_paths[stimulus]
        print(image_folder)
        ...
        images = torch.stack(
            [
                trans(cv2.cvtColor(cv2.imread(image_path), cv2.COLOR_BGR2RGB))
        ...
        save_features(
            image_features, stimulus, backbone_name, feature_name="Dinov2_embeddings"
        )
        print("saved")
